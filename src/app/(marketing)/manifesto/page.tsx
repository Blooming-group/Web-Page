...
const sections = [
  {
    ...
    body: [
      'The consulting industry has a volume problem — not too much work, but the habit of mistaking volume for value. A 200-slide deck is not more rigorous than a 20-slide deck. A six-month engagement is not inherently more valuable than a six-week one. The instinct to produce mass as proof of effort is the structural flaw of professional services — and it has compounded into an industry that is, by design, incapable of delivering the thing it claims to sell: clarity.',
  ...
  },
  {
    ...
    body: [
      'Dense Intelligence is the inverse of that model. It starts with a different question: if every element of what we deliver must earn its place — if nothing is decorative, nothing exists for volume, nothing is included because it fills a slide — what remains?',
