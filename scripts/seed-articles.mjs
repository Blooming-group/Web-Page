...
const articles = [
  ...
  // ── Article 3 ────────────────────────────────────────────────────────────
  {
    ...
    body: [
      ...
      boldP(
        ...
        ` The process that \u201cfeels slow\u201d is usually slow because it\u2019s waiting for something upstream. The real bottleneck is the constraint that, if removed, accelerates everything downstream. Finding it often requires asking uncomfortable questions about why things work the way they do \u2014 and the answer frequently points to a decision that was never revisited, not a process that needs automation.`
      ),
      boldP(
  ...
  // ── Article 4 ────────────────────────────────────────────────────────────
  {
    ...
    body: [
      ...
      callout(
        `Corporate intelligence is one of five capabilities Blooming deploys.`,
